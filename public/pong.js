...
function startVideo() {
    handTrack.startVideo(video).then(function (status) {
        ...
        if (status) {
            ...
            updateNote.innerText = "Por favor habilita la cámara"
        }
    });
}
...
$("input#sound").click(function () {
    ...
    soundtext = enableAudio ? "sonido encendido" : "sonido apagado";
...
planck.testbed(function (testbed) {
    ...
    function pauseGamePlay() {
        ...
        if (pauseGame) {
            ...
            $(".pauseoverlay").show()
            $(".overlaycenter").text("Juego pausado")
            $(".overlaycenter").animate({
                opacity: 1,
                fontSize: "4vw"
            }, pauseGameAnimationDuration, function () {});
...
saveData = () =>{
    person = prompt("Nombre(s) y apellidos(s):", "");
    id = prompt("N° documento de identidad:", "");
    
    const data = {
        nameAndLastname: person,
        pid: id,
